...
public class SecurityConf extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConf(ObjectMapper mapper, TokenStore tokenStore,
    ...
    protected void configure( HttpSecurity http ) throws Exception {
        http.csrf().disable().cors().and().authorizeRequests()
                ...
                .authorizationRequestRepository( new InMemoryRequestRepo() )
                .and()
    ...
    private void successHandler( HttpServletRequest request,
        ...
        User user = tokenStore.generateToken( authentication );
        response.getWriter().write(
                mapper.writeValueAsString( Collections.singletonMap( "user", user ) )
        );
    }
